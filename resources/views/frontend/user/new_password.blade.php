                 ...
                 <div class="row mt-5">
                     ...
                     <div class="col-lg-10 col-md-10">
                          ...
                          <div class="password_form_container"> 
                                 <form method="POST" id="set_new_password_form"  action="{{ route('set_new_password') }}">
                                        <div class="form_inside">
                                          <h4 class="password_heading"> Set New Password </h4>
                                            <div class="ps-form__content">
                                                ...
                                                <div class="form-group">
                                                    <input class="form-control" name="retype_password" required type="password" >
                                                </div>
