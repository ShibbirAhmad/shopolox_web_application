...
<ul class="sidebar_menu_container">
    ...
    <li> <a  href="{{ route('profile') }}">  <i class="fa fa-user mr-2 ml-4"></i>Profile</a> </li>
    <li> <a  href="{{ url('new/password') }} "> <i class="fa fa-key mr-2 ml-4"></i>Set New Password</a> </li>
    <li> <a  href="{{ url('/change/password')}} "> <i class="fa fa-key mr-2 ml-4"></i>Password Change</a> </li>
