                    ...
                    <aside class="widget widget_shop">
                        ...
                        <ul class="ps-list--categories">
                            @foreach($related_categories as $category)
                                <li class="menu-item-has-children"><a href="{{ route('sub_category_product',$category->slug) }}"> {{ $category->name }} </a> 
                                    @if (count($category->sub_sub_categories) > 0)
                                       <span class="sub-toggle"><i class="fa fa-angle-down"></i></span>
                                    <ul class="sub-menu">
                                        @foreach ($category->sub_sub_categories as $item)
                                        <li><a href="{{ route('sub_sub_category_product',$item->slug) }}">{{ $item->name }}</a>
                                        </li>
                                        @endforeach
                                    </ul>
                                    @endif
