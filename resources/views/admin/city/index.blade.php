...
@section('content')
    <div class="layout-px-spacing">
        ...
        <div class="row layout-top-spacing justify-content-center">
            ...
            <div class="col-lg-12">
                <button class="btn btn-primary mb-2 mr-2 btn-rounded modal_show" route="{{ route('city.create') }}"
                    modal-title="Create City">Add</button>
                                        ...
                                        @foreach ($cities as $city)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                 ...
                                                 @if ($city->status==1)
                                                    <a href="#" route="{{ route('city.destroy', $city->id) }}"
                                                    ...
                                                    <a href="#" route="{{ route('city.edit', $city->id) }}"
                                                        class="btn btn-sm btn-success modal_show_edit"
                                                        modal-title="Edit-{{ $city->name }}">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                    <a href="#" route="{{ route('city.show', $city->id) }}"
